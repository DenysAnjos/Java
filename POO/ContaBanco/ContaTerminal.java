...
public class ContaTerminal {
    ...
    public void depositar(double valor){
        if(getStatus()) {
            ...
            System.out.printf("Depósito de %.2f na conta de %s foi realizado com sucesso!", valor, getDono());
        }
        else
    ...
    public void sacar(double valor){
        if(getStatus()){
            if(getSaldo() < valor){
                System.out.printf("Seu saldo atual é de: %.2f, digite o valor de saque: %.2f", getSaldo(), valor);
                this.setSaldo(this.getSaldo() - valor);
                System.out.printf("Saque de %.2f na conta de %s foi realizado com sucesso!", valor, getDono());
            }
            else
